...
const CookiesPage = () => {
  return (
    <section id="cookies" className={styles["cookies"]}>
      <div className={styles["cookies__container"]}>
        <h1 className={styles["cookies__title"]}>Politique sur les Cookies</h1>
        <div>
          <h2>1 - Introduction</h2>
          <p>
            Notre site web, https://learning.unlocktoncomputer.fr/(ci-après : «
        ...
        <div>
          ...
          <div>
            <h3>5.2 - Cookies tiers de mesure d’audience</h3>
            <p>
          ...
          <div>
            <h3>5.3 - Cookies et navigateurs</h3>
            <p>
...
cookies"
        ...
        <div>
          <h2>7 - Vos droits concernant les données personnelles</h2>
          <p>
        ...
        <div>
          ...
          <div>
            ...
            <p>Site web: https://learning.unlocktoncomputer.fr/</p>
